...
const PERSPECTIVES = [
  ...
  { id:4, stat:"150,000", context:"people died today. 150,000 families are grieving right now.", question:"Everyone you love is still breathing. Act like it.", source:"UN Population Division — ~150K global deaths per day", category:"health" },
  ...
  { id:16, stat:"3.4 billion", context:"people don't have access to safely managed sanitation.", question:"You're on your phone in the bathroom right now. 3.4 billion people don't have one.", source:"WHO/UNICEF — 3.4B lack safely managed sanitation (2024)", category:"poverty" },
  ...
  { id:19, stat:"54 million", context:"children are in hazardous work that could kill or permanently injure them.", question:"Your kid complained about chores. These kids are losing fingers in factories.", source:"ILO/UNICEF — 54M in hazardous child labour (2024)", category:"freedom" },
  { id:20, stat:"12 million", context:"girls under 18 are forced into marriage every year.", question:"You spent 10 minutes deciding what to eat tonight. They never got to decide anything.", source:"UNICEF — 12M child marriages annually", category:"freedom" },
  ...
  { id:23, stat:"43 million", context:"children have been forcibly displaced from their homes by war or disaster.", question:"Kids with no home, no school, no safety. Your kid complained about their bedroom.", source:"UNHCR — refugee children (2024)", category:"freedom" },
  ...
  { id:27, stat:"10 million", context:"people contracted tuberculosis last year.", question:"You spent more than that on lunch. They died because they couldn't.", source:"WHO — Global TB Report (2024)", category:"health" },
  ...
  { id:31, stat:"87 million", context:"children in Sub-Saharan Africa are in child labour.", question:"You complained about your workload today. 87 million children would trade their job for yours.", source:"ILO — Sub-Saharan Africa child labour (2024)", category:"freedom" },
  ...
  { id:35, stat:"150,000", context:"people died today from illness, accidents, and violence.", question:"You ignored a call from someone who loves you because you couldn't be bothered.", source:"UN Population Division — ~150K global deaths per day", category:"health" },
  ...
  { id:38, stat:"168,000", context:"people across the world died today from all causes.", question:"You walked past someone without a second look. It might have been their last day.", source:"UN Population Division — global daily mortality", category:"health" },
  ...
  { id:42, stat:"150,000", context:"people died today. Every one of them had a name and a life.", question:"The stranger you gave a dirty look to on the train is someone's whole world.", source:"UN Population Division — ~150K global deaths per day", category:"health" },
  ...
  { id:50, stat:"55 million", context:"people are living with dementia worldwide.", question:"You forgot to reply to a text. They're forgetting their own children's names.", source:"WHO/ADI — 55M with dementia (2020)", category:"health" },
  ...
  { id:54, stat:"800", context:"women die every day from preventable causes related to pregnancy and childbirth.", question:"You complained about a GP waiting room. 800 women died just trying to give birth today.", source:"WHO — maternal mortality (2023)", category:"health" },
  { id:55, stat:"6,300", context:"newborns die every single day. Most from preventable causes.", question:"You moaned about broken sleep last night. A parent held their baby for the first and last time today.", source:"WHO/UNICEF — 2.3M neonatal deaths/year", category:"health" },
  ...
  { id:60, stat:"137", context:"women are killed by a family member every single day.", question:"You locked your door tonight and felt safe. 137 women were killed by the person inside theirs.", source:"UNODC — gender-related killings (2023)", category:"health" },
  { id:61, stat:"43 million", context:"people worldwide are completely blind and will never see again.", question:"They would give anything to see their family's face one more time. You looked at yours and reached for your phone.", source:"WHO — global blindness estimates", category:"health" },
  ...
  { id:68, stat:"1.2 billion", context:"people live in acute multidimensional poverty.", question:"You have all three and still found something to moan about today.", source:"UNDP/OPHI — Multidimensional Poverty Index (2023)", category:"poverty" },
  ...
  { id:72, stat:"54 million", context:"children do work classified as hazardous by the ILO.", question:"You called in sick because you were tired. A 10-year-old is breaking rocks in a quarry right now.", source:"ILO/UNICEF — 54M in hazardous child labour (2024)", category:"freedom" },
  { id:73, stat:"12 million", context:"girls are married off before their 18th birthday each year.", question:"You agonised over what to wear on a date. She didn't get a date. She got a contract.", source:"UNICEF — 12M child marriages annually", category:"freedom" },
  ...
  { id:76, stat:"3.3 million", context:"children are in forced labour.", question:"You counted down to the weekend. They don't get weekends. They don't get holidays. Ever.", source:"ILO — child forced labour estimates (2021)", category:"freedom" },
  ...
  { id:78, stat:"43 million", context:"children are living as refugees with no permanent home.", question:"Your child sleeps in the same bed every night. That's not normal for 43 million kids.", source:"UNHCR — refugee children (2024)", category:"freedom" },
  ...
  { id:80, stat:"168,000", context:"people died today. None of them expected it to be their last morning.", question:"Your alarm went off and you hit snooze. 168,000 people's alarms will never ring again.", source:"UN Population Division — global daily mortality", category:"health" },
  { id:81, stat:"2,000", context:"people died by suicide today. Their families had no idea.", question:"You had time to scroll for two hours but not enough to reply to one message.", source:"WHO — 727,000 suicides/year (2021)", category:"health" },
  { id:82, stat:"55,000", context:"people heard 'you have cancer' today.", question:"You heard 'your order is ready.' They heard 'it's cancer.'", source:"WHO/IARC — 20M new cases/year (2022)", category:"health" },
  { id:83, stat:"168,000", context:"people died today from heart failure, cancer, accidents, and disease.", question:"Yours didn't. And you spent it angry about parking.", source:"UN Population Division — global daily mortality", category:"health" },
  { id:84, stat:"2,000", context:"people died by suicide today because the pain became too much.", question:"You were too busy with your own problems to notice theirs.", source:"WHO — 727,000 suicides/year (2021)", category:"health" },
  ...
  { id:89, stat:"2,000", context:"people died by suicide today.", question:"You were in a room full of people today and didn't speak to a single one of them.", source:"WHO — 727,000 suicides/year (2021)", category:"health" },
  ...
  { id:94, stat:"10 million", context:"people get tuberculosis every year. It kills 1.3 million of them.", question:"You took a paracetamol for a headache today without thinking. They can't afford the pill that saves their life.", source:"WHO — Global TB Report (2024)", category:"health" },
  { id:95, stat:"1,600", context:"children died from malaria today.", question:"You spent $5 on a snack today. A $2 net could have saved a child's life.", source:"WHO — ~600,000 malaria deaths/year (2022)", category:"health" },
  { id:96, stat:"800", context:"women died in childbirth today.", question:"Giving birth killed them. You complained about a doctor's waiting room.", source:"WHO — maternal mortality (2023)", category:"health" },
  { id:97, stat:"2", context:"people die every single second across the world.", question:"Two people died while you read this sentence. You're still here.", source:"UN Population Division — ~62M deaths/year", category:"health" },
  ...
  { id:99, stat:"105", context:"people die every minute from disease, hunger, violence, and age.", question:"In the time it takes you to complain about your day, a life ends somewhere.", source:"UN Population Division — ~150K deaths/day", category:"health" },
  ...
  { id:101, stat:"168,000", context:"people died today. Their time simply ran out.", question:"You said 'there's always tomorrow.' There isn't. Not for everyone.", source:"UN Population Division — global daily mortality", category:"health" },
  ...
  { id:103, stat:"2.2 billion", context:"people risk their health every time they take a drink of water.", question:"You poured a glass of water today without a single thought. 2.2 billion people can't do that.", source:"WHO/UNICEF — 2.2B (2024)", category:"poverty" },
  ...
  { id:105, stat:"50 million", context:"people have no freedom. No choice. No autonomy.", question:"You spent 20 minutes deciding which show to watch. 50 million people can't decide when to sleep.", source:"ILO — 50M in modern slavery (2021)", category:"freedom" },
  ...
  { id:112, stat:"280 million", context:"people worldwide are living with clinical depression every single day.", question:"You called someone lazy this week. They might be fighting just to get out of bed.", source:"WHO — depression global estimates (2023)", category:"health" },
  ...
  { id:115, stat:"168,000", context:"people died today across every country on Earth.", question:"You honked at someone in traffic. It might have been a father racing to the hospital.", source:"UN Population Division — global daily mortality", category:"health" },
  ...
  { id:119, stat:"1 in 3", context:"women worldwide have experienced physical or sexual violence in their lifetime.", question:"She's sitting next to you on the bus. She's in your office. She's your friend. And she never told you.", source:"WHO — violence against women (2021)", category:"health" },
  { id:120, stat:"150,000", context:"people died today. Some alone. Some surrounded by family.", question:"You ghosted someone. They might have needed you more than you'll ever know.", source:"UN Population Division — ~150K global deaths/day", category:"health" },
  { id:121, stat:"168,000", context:"people died today who fully expected to wake up tomorrow.", question:"You said 'I'll do it later.' 168,000 people found out today that later doesn't always come.", source:"UN Population Division — global daily mortality", category:"health" },
  ...
  { id:129, stat:"700 million", context:"people live in extreme poverty with less than $2.15 a day.", question:"You have everything and you're still not happy. 700 million people have nothing and would kill for your worst day.", source:"World Bank — extreme poverty line (2024)", category:"poverty" },
  { id:130, stat:"150,000", context:"people died today. Each one had a story that just ended.", question:"Yours is still being written. So far it's mostly complaints and screen time.", source:"UN Population Division — ~150K deaths/day", category:"health" },
  ...
  { id:133, stat:"168,000", context:"people died today. Not one of them saw it coming.", question:"You assume you'll wake up tomorrow. 168,000 people made that same assumption this morning.", source:"UN Population Division — global daily mortality", category:"health" },
  ...
  { id:135, stat:"2,000", context:"people died by suicide today. They decided they couldn't keep going.", question:"You told someone to 'stay positive' instead of actually listening to them.", source:"WHO — 727,000 suicides/year (2021)", category:"health" },
  { id:136, stat:"150,000", context:"people died today. They took their last breath and that was it.", question:"You still have yours. You used it to argue with strangers online.", source:"UN Population Division — ~150K deaths/day", category:"health" },
  ...
  { id:138, stat:"13,400", context:"children died today from causes that were entirely preventable.", question:"You walked past a charity collector today. 13,400 children didn't make it home.", source:"WHO/UNICEF — 4.9M under-5 deaths/year (2022)", category:"health" },
  ...
  { id:140, stat:"1,700", context:"Americans lost their fight with cancer today.", question:"You've been putting off that health check for months. Some of them did the same. They're dead now.", source:"ACS — 618,120 US cancer deaths (2025)", category:"health" },
  { id:141, stat:"49,000", context:"people died from heart disease today.", question:"You said you'd start taking care of yourself 'soon.' 49,000 people ran out of 'soon' today.", source:"WHO — 17.9M cardiovascular deaths/year", category:"health" },
  { id:143, stat:"62 million", context:"people die every year globally. That is the entire population of Italy.", question:"You spent today worrying about things that won't matter next week. 62 million people ran out of weeks this year.", source:"UN Population Division — annual global mortality", category:"health" },
  { id:144, stat:"1.19 million", context:"people die in road crashes every year.", question:"You drove 10 over the limit today. 1.19 million people a year die on roads just like yours.", source:"WHO — road traffic deaths (2021)", category:"health" },
  { id:145, stat:"122 million", context:"displaced people could fill every football stadium on Earth.", question:"You complained about your house being too small. 122 million people don't have one.", source:"UNHCR — 122M+ forcibly displaced (2024)", category:"freedom" },
  { id:146, stat:"273 million", context:"children out of school is more than the population of Indonesia.", question:"You sat through a boring meeting today. 273 million kids would give anything to sit in any room with a teacher.", source:"UNESCO — 273M out of school (2024)", category:"freedom" },
  { id:147, stat:"700 million", context:"people in extreme poverty is double the population of the United States.", question:"You said 'there's nothing to eat' in front of a full fridge. 700 million people meant it.", source:"World Bank — extreme poverty line (2024)", category:"poverty" },
  { id:148, stat:"50 million", context:"people in modern slavery is more than the population of Spain.", question:"You complained about your boss. 50 million people can't quit. Can't leave. Can't say no.", source:"ILO — 50M (2021)", category:"freedom" },
  { id:149, stat:"55 million", context:"people with dementia is more than the population of South Korea.", question:"You forgot where you put your keys and got annoyed. 55 million people are forgetting who they are.", source:"WHO/ADI — 55M with dementia (2020)", category:"health" },
  ...
  { id:151, stat:"1 in 2", context:"children globally — about 1 billion — face at least one severe deprivation.", question:"You have food, water, a toilet, a roof, an education, and a doctor. A billion children don't have all six.", source:"UNICEF — child deprivation estimates", category:"poverty" },
  { id:152, stat:"168,000", context:"people died today. They left home this morning and never came back.", question:"You have no idea how lucky you are to be bored right now.", source:"UN Population Division — global daily mortality", category:"health" },
  ...
  { id:155, stat:"43 million", context:"children are living as refugees, displaced by war and conflict.", question:"Your kid got upset about not getting the toy they wanted. These kids don't have a home.", source:"UNHCR — refugee children (2024)", category:"freedom" },
  ...
  { id:159, stat:"3,200", context:"people died on the road today.", question:"You road-raged at someone today. 3,200 people got in a car this morning and never came back.", source:"WHO — 1.19M road deaths/year (2021)", category:"health" },
  { id:160, stat:"800", context:"women died giving birth today.", question:"You stressed about a baby shower guest list. 800 women died just trying to deliver today.", source:"WHO — maternal mortality (2023)", category:"health" },
  ...
  { id:163, stat:"150,000", context:"people died today. Their families are planning funerals right now.", question:"You can't hug someone who's gone. And you didn't hug them when they were here.", source:"UN Population Division — ~150K deaths/day", category:"health" },
  ...
  { id:167, stat:"2,000", context:"people died by suicide today. Nobody saw it coming.", question:"Someone needed to hear 'I'm here for you' and nobody said it.", source:"WHO — 727,000 suicides/year (2021)", category:"health" },
  { id:168, stat:"168,000", context:"people died today and will never come back.", question:"You're not. And you spent today acting like you'd live forever.", source:"UN Population Division — global daily mortality", category:"health" },
  { id:169, stat:"13,400", context:"children under 5 died today from preventable disease, hunger, and unsafe water.", question:"They never got to grow up. You did. What are you doing with it?", source:"WHO/UNICEF — 4.9M under-5 deaths/year (2022)", category:"health" },
  { id:170, stat:"6,300", context:"newborn babies died today, most from preventable causes.", question:"Their parents will never hear their first word. You ignored your kid's tenth story today.", source:"WHO/UNICEF — 2.3M neonatal deaths/year", category:"health" },
  ...
  { id:173, stat:"55 million", context:"people are losing their mind. Literally.", question:"You got annoyed because you forgot where you put your keys. They're forgetting their children's faces.", source:"WHO/ADI — 55M with dementia (2020)", category:"health" },
  { id:175, stat:"122 million", context:"people have been forcibly displaced from their homes worldwide.", question:"Imagine waking up and everything you own fits in a plastic bag. That's reality for 122 million people.", source:"UNHCR — 122M+ forcibly displaced (2024)", category:"freedom" },
  { id:176, stat:"39 million", context:"people are living with HIV.", question:"You see a doctor whenever you want. 39 million people are living with a ticking clock.", source:"UNAIDS — people living with HIV (2023)", category:"health" },
  { id:177, stat:"10 million", context:"people got TB last year.", question:"You popped a pill for a sore throat today. They died from something a pill could fix.", source:"WHO — Global TB Report (2024)", category:"health" },
  { id:178, stat:"137", context:"women were murdered by a partner or family member today.", question:"You argued with your partner over something petty. 137 women were killed by theirs today.", source:"UNODC — gender-related killings (2023)", category:"health" },
  ...
  { id:180, stat:"1.2 billion", context:"people are trapped in multidimensional poverty.", question:"You have healthcare, education, clean water, and electricity. 1.2 billion people have none of it.", source:"UNDP/OPHI — MPI (2023)", category:"poverty" },
  ...
  { id:182, stat:"650 million", context:"women alive today were married before they turned 18.", question:"You look back on your teenage years fondly. 650 million women never got to have them.", source:"UNICEF — child marriage global database", category:"freedom" },
  { id:183, stat:"28 million", context:"people are working under force.", question:"You handed in your notice once because you didn't like the job. 28 million people can't hand in anything.", source:"ILO — forced labour estimate (2021)", category:"freedom" },
  { id:184, stat:"3.3 million", context:"children are trapped in forced labour worldwide.", question:"Your kid played video games after school today. 3.3 million children their age are in forced labour.", source:"ILO — child forced labour (2021)", category:"freedom" },
  { id:185, stat:"168,000", context:"people died today. This morning was their last morning alive.", question:"Tomorrow isn't promised. It never was. Tell the people you love that you love them.", source:"UN Population Division — global daily mortality", category:"health" },
  ...
  { id:188, stat:"2,000", context:"people died by suicide today. They reached a point of no return.", question:"Someone you know is drowning and you're too distracted to notice the silence.", source:"WHO — 727,000 suicides/year (2021)", category:"health" },
  ...
  { id:190, stat:"55 million", context:"people are slowly becoming strangers to themselves.", question:"You take a photo of every meal you eat. 55 million people can't remember what they had for breakfast.", source:"WHO/ADI — 55M with dementia (2020)", category:"health" },
  { id:191, stat:"150,000", context:"people died today. Each had a favourite song, a best friend, and a plan for next week.", question:"Every one of them had a favourite song, a best friend, a fear, a hope. Just like you. Now they're gone.", source:"UN Population Division — ~150K deaths/day", category:"health" },
  ...
  { id:193, stat:"50 million", context:"people are trapped in modern slavery with no freedom and no way out.", question:"You are. That sentence should change your entire day.", source:"ILO — 50M in modern slavery (2021)", category:"freedom" },
  { id:194, stat:"168,000", context:"people died today. They breathed in and never breathed out again.", question:"You woke up annoyed about a Monday morning. 168,000 people didn't wake up at all.", source:"UN Population Division — global daily mortality", category:"health" },
  { id:195, stat:"2,000", context:"people died by suicide today because the weight crushed them.", question:"You have no idea what the person sitting next to you is carrying. But you judged them anyway.", source:"WHO — 727,000 suicides/year (2021)", category:"health" },
  ...
  { id:197, stat:"122 million", context:"people were forced from their homes and lost everything they had.", question:"Everything you're worried about right now — they'd take your problems in a heartbeat.", source:"UNHCR — 122M+ forcibly displaced (2024)", category:"freedom" },
  { id:198, stat:"55,000", context:"people were told they have cancer today. Their world collapsed.", question:"You said the universe is against you today. 55,000 people got told they have cancer. Your universe is fine.", source:"WHO/IARC — 20M new cases/year (2022)", category:"health" },
  { id:199, stat:"150,000", context:"people died today. For them, tomorrow no longer exists.", question:"You didn't. Don't waste it.", source:"UN Population Division — ~150K deaths/day", category:"health" },
  { id:200, stat:"168,000", context:"people died today. Their chairs at dinner will be empty tonight.", question:"You spent today doing nothing that mattered and tomorrow you'll do the same.", source:"UN Population Division — global daily mortality", category:"health" },
  ...
  { id:202, stat:"2,000", context:"people died by suicide today. Their families will never understand why.", question:"Someone reached out to you recently. You left them on read.", source:"WHO — 727,000 suicides/year (2021)", category:"health" },
  ...
  { id:204, stat:"168,000", context:"people died today while you were alive to read this.", question:"And here you are, alive, reading this, and you'll probably forget about it in 30 seconds.", source:"UN Population Division — global daily mortality", category:"health" },
];
